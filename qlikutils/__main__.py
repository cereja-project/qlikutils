...
if __name__ == "__main__":
    ...
    parser.add_argument('--subtitle', type=str, required=False, default='', help='project subtitle to be displayed in the thumbnail (max 30 characters)')
    parser.add_argument('--version', type=str, required=False, default='', help='project version to be displayed in the thumbnail (max 10 characters) (e.g. "v1.0", "v2.0")')
